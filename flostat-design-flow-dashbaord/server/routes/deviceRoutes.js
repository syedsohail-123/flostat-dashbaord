...
import { getSCADAData, updateDeviceState, updateSCADAMode } from "../controllers/Scada.js";
...
// --------------- SCADA ROUTES ---------------
router.get("/scada/:org_id", getSCADAData)//-
router.put("/scada/updateState", verifyAuth, IsController, updateDeviceState)//c
router.put("/scada/mode", verifyAuth, IsController, updateSCADAMode)//c
