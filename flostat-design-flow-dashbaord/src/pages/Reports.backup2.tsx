...
export default function Reports() {
  const { authToken, currentOrganization, organizations } = useAuth(); // Get auth token, current organization, and organizations from context
    ...
    try {
      ...
      if (authToken && currentOrganization) {
        ...
        if (!authToken) {
          ...
          toast.info("No organization found. Please contact your administrator to be added to an organization.");
        } else {
